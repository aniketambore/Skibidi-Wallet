...
class MuddyEnemy extends SimpleEnemy with BlockMovementCollision, UseLifeBar {
  ...
  MuddyEnemy(this.initPosition, this.onShowMnemonic)
    : super(
        animation: SimpleDirectionAnimation(
          idleRight: EnemySpriteSheet.muddyRight(),
          runRight: EnemySpriteSheet.muddyRight(),
        ),
  ...
  void _showDialog() {
    ...
    TalkDialog.show(
      ...
      [
        Say(
          text: [
            TextSpan(text: "Ready to get dirty for those words? Bring it on!"),
          ],
          person: CustomSpriteAnimationWidget(
            animation: EnemySpriteSheet.muddyRight(),
          ),
  ...
  void onDie() {
    ...
    if (gameRef.player != null) {
      (gameRef.player as PlayerBob).receiveWordsFromMuddyEnemy();
    }
