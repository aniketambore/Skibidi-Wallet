  ...
  static BigInt parseToBigInt(
    ...
    try {
      if (value == null) {
        ...
        _logger.warning(
          'Invalid type for BigInt field $fieldName: ${value.runtimeType}',
        );
        return defaultVal;
      }
    } catch (e, stack) {
      _logger.severe(
        'Error parsing BigInt from $value for field $fieldName: $e\n$stack',
      );
      return defaultVal;
    }
  }
  ...
  static int parseToInt(
    ...
    try {
      if (value == null) {
        ...
        _logger.warning(
          'Invalid type for int field $fieldName: ${value.runtimeType}',
        );
        return defaultVal;
      }
    } catch (e, stack) {
      _logger.severe(
        'Error parsing int from $value for field $fieldName: $e\n$stack',
      );
      return defaultVal;
    }
  }
