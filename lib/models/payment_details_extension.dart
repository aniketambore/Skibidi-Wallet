...
extension PaymentDetailsMapExtension on PaymentDetails {
  T map<T>({
    ...
    if (this is PaymentDetails_Bitcoin) {
      return bitcoin != null
          ? bitcoin(this as PaymentDetails_Bitcoin)
          : orElse();
    } else if (this is PaymentDetails_Lightning) {
      return lightning != null
          ? lightning(this as PaymentDetails_Lightning)
          : orElse();
...
extension PaymentDetailsToJson on PaymentDetails {
  Map<String, dynamic>? toJson() {
    return map(
      lightning:
          (PaymentDetails_Lightning details) => <String, dynamic>{
            'type': 'lightning',
      ...
      liquid:
          (PaymentDetails_Liquid details) => <String, dynamic>{
            'type': 'liquid',
      ...
      bitcoin:
          (PaymentDetails_Bitcoin details) => <String, dynamic>{
            'type': 'bitcoin',
            'swapId': details.swapId,
            ...
            'bitcoinExpirationBlockheight':
                details.bitcoinExpirationBlockheight,
            'claimTxId': details.claimTxId,
            'refundTxId': details.refundTxId,
            'refundTxAmountSat': details.refundTxAmountSat?.toString(),
          },
    ...
    switch (json['type']) {
      case 'lightning':
        return PaymentDetails.lightning(
          ...
          liquidExpirationBlockheight:
              json['liquidExpirationBlockheight'] as int,
      ...
      case 'liquid':
        return PaymentDetails.liquid(
          ...
          assetInfo:
              json['assetInfo'] != null
                  ? AssetInfoFromJson.fromJson(json['assetInfo'])
                  : null,
          lnurlInfo:
              json['lnurlInfo'] != null
                  ? LnUrlInfoFromJson.fromJson(json['lnurlInfo'])
      ...
      case 'bitcoin':
        return PaymentDetails.bitcoin(
          ...
          liquidExpirationBlockheight:
              json['liquidExpirationBlockheight'] as int?,
          bitcoinExpirationBlockheight:
              json['bitcoinExpirationBlockheight'] as int?,
          claimTxId: json['claimTxId'] as String?,
          refundTxId: json['refundTxId'] as String?,
          refundTxAmountSat:
              json['refundTxAmountSat'] != null
        ...
        other.runtimeType == runtimeType &&
            other.map(
              lightning: (PaymentDetails_Lightning o) {
                final PaymentDetails_Lightning current =
                    this as PaymentDetails_Lightning;
                return o.swapId == current.swapId &&
                    o.description == current.description &&
                    o.liquidExpirationBlockheight ==
                        current.liquidExpirationBlockheight &&
              ...
              liquid: (PaymentDetails_Liquid o) {
                final PaymentDetails_Liquid current =
                    this as PaymentDetails_Liquid;
              ...
              bitcoin: (PaymentDetails_Bitcoin o) {
                final PaymentDetails_Bitcoin current =
                    this as PaymentDetails_Bitcoin;
                return o.swapId == current.swapId &&
                    ...
                    o.bitcoinExpirationBlockheight ==
                        current.bitcoinExpirationBlockheight &&
                    o.claimTxId == current.claimTxId &&
                    o.refundTxId == current.refundTxId &&
                    o.refundTxAmountSat == current.refundTxAmountSat;
              },
...
extension PaymentDetailsHashCode on PaymentDetails {
  int calculateHashCode() {
    return map(
      lightning:
          (PaymentDetails_Lightning o) => Object.hash(
            o.swapId,
            o.description,
            o.liquidExpirationBlockheight,
            o.preimage,
      ...
      liquid:
          (PaymentDetails_Liquid o) => Object.hash(
            o.destination,
            o.description,
            o.assetId,
            o.assetInfo?.toJson(),
      ...
      bitcoin:
          (PaymentDetails_Bitcoin o) => Object.hash(
            o.swapId,
            o.bitcoinAddress,
            o.description,
            o.autoAcceptedFees,
...
extension PaymentDetailsExpiryDate on PaymentDetails {
  DateTime? getExpiryDate({required BlockchainInfo? blockchainInfo}) {
    ...
    final int? expiryBlockheight = map(
      bitcoin:
          (PaymentDetails_Bitcoin details) =>
              details.bitcoinExpirationBlockheight,
      lightning:
          (PaymentDetails_Lightning details) =>
              details.liquidExpirationBlockheight,
      orElse: () => null,
    );
    ...
    return map(
      bitcoin:
          (_) => BreezDateUtils.bitcoinBlockDiffToDate(
            blockHeight: currentTip,
            expiryBlock: expiryBlockheight,
          ),
      lightning:
          (_) => BreezDateUtils.liquidBlockDiffToDate(
            blockHeight: currentTip,
            expiryBlock: expiryBlockheight,
          ),
      orElse: () => null,
...
extension LnUrlInfoToJson on LnUrlInfo {
  Map<String, dynamic> toJson() => <String, dynamic>{
    ...
    'lnurlPayUnprocessedSuccessAction':
        lnurlPayUnprocessedSuccessAction?.toJson(),
  ...
  static LnUrlInfo fromJson(Map<String, dynamic> json) {
    return LnUrlInfo(
      ...
      lnurlPaySuccessAction:
          json['lnurlPaySuccessAction'] != null
              ? SuccessActionProcessedFromJson.fromJson(
                json['lnurlPaySuccessAction'],
              )
              : null,
      lnurlPayUnprocessedSuccessAction:
          json['lnurlPayUnprocessedSuccessAction'] != null
              ? SuccessActionFromJson.fromJson(
                json['lnurlPayUnprocessedSuccessAction'],
              )
              : null,
...
extension AesSuccessActionDataResultFromJson on AesSuccessActionDataResult {
  static AesSuccessActionDataResult fromJson(Map<String, dynamic> json) {
    switch (json['type']) {
      ...
      default:
        throw Exception(
          'Unknown AesSuccessActionDataResult type: ${json['type']}',
        );
    }
  }
}
...
extension AesSuccessActionDataDecryptedFromJson
    on AesSuccessActionDataDecrypted {
