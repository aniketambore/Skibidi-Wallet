...
import 'package:bitwit_shit/bloc/payments/models/payment_filters.dart';
...
class PaymentsCubit extends Cubit<PaymentsState>
    ...
    Rx.combineLatest2<List<Payment>, PaymentFilters, PaymentsState>(
      ...
      (List<Payment> payments, PaymentFilters paymentFilters) {
        return state.copyWith(
          payments:
              payments.map((Payment e) => PaymentData.fromPayment(e)).toList(),
  ...
  String get storagePrefix =>
      defaultTargetPlatform == TargetPlatform.iOS ? 'IWa' : 'PaymentsCubit';
}
